...
interface CountryResidenceScreenProps {
  navigation?: any;
}

const CountryResidenceScreen: React.FC<CountryResidenceScreenProps> = ({
  navigation,
}) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView
        ...
        {/* Title */}
        <Text style={styles.title}>What's your country of residence?</Text>
...
export default CountryResidenceScreen;
