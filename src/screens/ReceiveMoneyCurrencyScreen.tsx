...
interface ReceiveMoneyCurrencyScreenProps {
  navigation?: any;
}

const ReceiveMoneyCurrencyScreen: React.FC<ReceiveMoneyCurrencyScreenProps> = ({
  navigation,
}) => {
      ...
      <ScrollView
          ...
          <View style={styles.amountRow}>
            <View style={styles.amountLeft}>
              <TextInput
                ...
                color="#1F2937"
              />
              <Text style={styles.amountLabel}>They send</Text>
            </View>
        ...
        <View style={styles.feeCard}>
          <View style={styles.feeRow}>
            ...
            <Text style={styles.feeValue}>EUR 0,00</Text>
          </View>
          <View style={styles.feeRow}>
            <Text style={styles.feeLabel}>Total</Text>
            <Text style={[styles.feeValue, styles.totalValue]}>EUR 0,00</Text>
          </View>
        </View>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
          onPress={() => navigation?.navigate('ReceiveDeliveryMethod')}>
...
export default ReceiveMoneyCurrencyScreen;
