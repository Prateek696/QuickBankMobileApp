...
const BankSelectionScreen: React.FC<BankSelectionScreenProps> = ({
  navigation,
}) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        {/* Title */}
        <Text style={styles.title}>Search you recipient's bank</Text>
        ...
        <FlatList
          ...
          renderItem={({item}) => (
            <TouchableOpacity
              ...
              onPress={() => navigation?.navigate('SendMoneyCurrency')}>
